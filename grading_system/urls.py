...
urlpatterns = [
    ...
    path('faculty/edit/student/subject-grade/<int:user_id>/<user_full_name>/<int:subject_grade_id>/<school_year>/',
    ...
    path('faculty/edit/student/final-grade/<int:user_id>/<int:level_id>/<school_year>/',
